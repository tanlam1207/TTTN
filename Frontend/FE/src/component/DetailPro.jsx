      ...
      <div className="row">
          ...
          <div className="card">
            <article className="gallery-wrap"> 
              ...
              <div className="thumbs-wrap">
                <a href="#" className="item-thumb"> <img src={`asset/images/items/${product.sku}`} /></a>
        ...
        <main className="col-md-6">
          <article className="product-info-aside">
            ...
            <div className="mb-3"> 
              <var className="price h4">{formatCurrency(product.regular_price)}</var> 
        ...
        <aside className="col-md-4">
          <div className="box">
            ...
            <article className="media mb-3">
              <a href="#"><img className="img-sm mr-3" src="asset/images/posts/3.jpg" /></a>
            ...
            <article className="media mb-3">
              <a href="#"><img className="img-sm mr-3" src="asset/images/posts/2.jpg" /></a>
              <div className="media-body">
            ...
            <article className="media mb-3">
              <a href="#"><img className="img-sm mr-3" src="asset/images/posts/1.jpg" /></a>
              <div className="media-body">
                <h6 className="mt-0"><a href="#">New tips and tricks</a></h6>
                <p className="mb-2"> Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin </p>
              </div>
